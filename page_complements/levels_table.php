...
$whole_table_query = "SELECT name, levels.user_name, SUM(IF(vote = 1, 1, 0)) as upvotes, SUM(IF(vote = -1, 1, 0)) AS downvotes, id FROM levels,votes";
if (isset($_GET['search'])) {
    ...
    $whole_table_query = $whole_table_query . " WHERE levels.id = votes.level_id GROUP BY name, levels.user_name";
}
